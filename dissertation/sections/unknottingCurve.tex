...
\begin{figure}[tbp]
    ...
    \caption{$-\Grad_{H^1} \left( \Gammabf^k \right)$, again represented by arrows. Unlike $L^2$ gradient at Figure \ref{fig: L2Derivative}, direction of arrows are more aligned with its neighbours.}
\end{figure}
